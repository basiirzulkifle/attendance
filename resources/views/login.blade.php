...
<head>
    ...
    <link href="{{asset('assets/admin/fonts/bootstrap-icons.css')}}" rel="stylesheet">
        ...
        <div class="row g-0">
            ...
            <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex bg-primary">
                ...
                <div class="card rounded-0 mb-0 border-0 bg-transparent">
                    <div class="card-body">
                        <img src="{{ asset('assets/admin/images/boxed-login.png') }}" class="img-fluid auth-img-cover-login" width="650"
                             alt="">
                    </div>
                </div>
            ...
            <div class="col-12 col-xl-5 col-xxl-4 auth-cover-right align-items-center justify-content-center">
                <div class="card rounded-0 m-3 mb-0 border-0">
                    <div class="card-body p-sm-5">
                        <img src="{{ asset('assets/admin/images/hrms.png') }}" class="mb-4" width="45" alt="">
